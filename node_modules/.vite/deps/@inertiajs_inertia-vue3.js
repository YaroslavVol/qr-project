import {
  require_dist
} from "./chunk-PIBR4PNH.js";
import {
  require_vue
} from "./chunk-656NROLF.js";
import "./chunk-XFD2A5SJ.js";
import {
  __commonJS
...
var require_dist2 = __commonJS({
  "node_modules/@inertiajs/inertia-vue3/dist/index.js"(exports) {
    ...
    function a() {
      var e2 = [].slice.call(arguments), a2 = typeof e2[0] == "string" ? e2[0] : null, u2 = (typeof e2[0] == "string" ? e2[1] : e2[0]) || {}, s2 = a2 ? o.Inertia.restore(a2) : null, c2 = n(u2), l2 = null, p2 = null, f2 = function(e3) {
        return e3;
        ...
        var t2;
        return c2 = e3 === void 0 ? this.data() : Object.assign({}, n(c2), r2 ? ((t2 = {})[e3] = r2, t2) : e3), this;
      }, reset: function() {
        var e3 = [].slice.call(arguments), r2 = n(c2);
        return Object.assign(this, e3.length === 0 ? r2 : Object.keys(r2).filter(function(r3) {
        ...
        e3 === "delete" ? o.Inertia.delete(r2, i({}, d3, { data: s3 })) : o.Inertia[e3](r2, s3, d3);
      }, get: function(e3, r2) {
        ...
        l2 && l2.cancel();
      }, __rememberable: a2 === null, __remember: function() {
    ...
    var u = { created: function() {
      ...
      if (this.$options.remember) {
        ...
        var r2 = this.$options.remember.key instanceof Function ? this.$options.remember.key.call(this) : this.$options.remember.key, t2 = o.Inertia.restore(r2), a2 = this.$options.remember.data.filter(function(r3) {
          return !(e2[r3] !== null && typeof e2[r3] == "object" && e2[r3].__rememberable === false);
        }), u2 = function(r3) {
          return e2[r3] !== null && typeof e2[r3] == "object" && typeof e2[r3].__remember == "function" && typeof e2[r3].__restore == "function";
        };
        a2.forEach(function(s2) {
          e2[s2] !== void 0 && t2 !== void 0 && t2[s2] !== void 0 && (u2(s2) ? e2[s2].__restore(t2[s2]) : e2[s2] = t2[s2]), e2.$watch(s2, function() {
    ...
    var f = { name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: function(e2) {
      ...
      var d2 = typeof window == "undefined";
      return p = o.createHeadManager(d2, u2, f2), d2 || o.Inertia.init({ initialPage: r2, resolveComponent: a2, swapComponent: function(e3) {
        ...
        if (s.value) {
          ...
          return s.value.layout ? typeof s.value.layout == "function" ? s.value.layout(t.h, e3) : (Array.isArray(s.value.layout) ? s.value.layout : [s.value.layout]).concat(e3).reverse().reduce(function(e4, r3) {
    ...
    var h = { props: { title: { type: String, required: false } }, data: function() {
      ...
      var r2 = this;
      return typeof e2.children == "string" ? e2.children : e2.children.reduce(function(e3, t2) {
        return e3 + r2.renderTag(t2);
      }, "");
    }, renderTag: function(e2) {
      if (e2.type.toString() === "Symbol(Text)")
        return e2.children;
      if (e2.type.toString() === "Symbol()")
        return "";
      if (e2.type.toString() === "Symbol(Comment)")
        return "";
      ...
      return this.addTitleElement(e2.flatMap(function(e3) {
        return e3.type.toString() === "Symbol(Fragment)" ? e3.children : e3;
      }).map(function(e3) {
    ...
    var m = { name: "InertiaLink", props: { as: { type: String, default: "a" }, data: { type: Object, default: function() {
      ...
      return function(e3) {
        ...
        return r3 === "a" && u2 !== "get" && console.warn('Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.\n\nPlease specify a more appropriate element using the "as" attribute. For example:\n\n<Link href="' + c2 + '" method="' + u2 + '" as="button">...</Link>'), t.h(e3.as, i({}, a2, r3 === "a" ? { href: c2 } : {}, { onClick: function(r4) {
          var t2;
          o.shouldIntercept(r4) && (r4.preventDefault(), o.Inertia.visit(c2, { data: l2, method: u2, replace: e3.replace, preserveScroll: e3.preserveScroll, preserveState: (t2 = e3.preserveState) != null ? t2 : u2 !== "get", only: e3.only, headers: e3.headers, onCancelToken: a2.onCancelToken || function() {
            return {};
    ...
    exports.App = f, exports.Head = h, exports.InertiaApp = f, exports.InertiaHead = h, exports.InertiaLink = m, exports.Link = m, exports.app = f, exports.createInertiaApp = function(e2) {
      try {
        ...
        n2 = (r2 = e2.id) === void 0 ? "app" : r2, o2 = e2.resolve, i2 = e2.setup, a2 = e2.title, u2 = e2.page, s2 = e2.render;
        var c2 = typeof window == "undefined", l2 = c2 ? null : document.getElementById(n2), p2 = u2 || JSON.parse(l2.dataset.page), h2 = function(e3) {
      ...
      if (typeof e2 == "object" && e2 !== null && e2.__rememberable === false)
        return e2;
      var i2 = o.Inertia.restore(r2), a2 = t.isReactive(e2) ? t.reactive : t.ref, u2 = typeof e2.__remember == "function" && typeof e2.__restore == "function", s2 = i2 === void 0 ? e2 : a2(u2 ? e2.__restore(i2) : i2);
