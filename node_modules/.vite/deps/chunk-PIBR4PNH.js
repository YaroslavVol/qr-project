...
var require_dist = __commonJS({
  "node_modules/@inertiajs/inertia/dist/index.js"(exports) {
    ...
    function c(e2, t2, n2) {
      for (var i2 in t2 === void 0 && (t2 = new FormData()), n2 === void 0 && (n2 = null), e2 = e2 || {})
    ...
    function d(e2, t2, n2) {
      ...
      }) : n2 instanceof Date ? e2.append(t2, n2.toISOString()) : n2 instanceof File ? e2.append(t2, n2, n2.name) : n2 instanceof Blob ? e2.append(t2, n2) : typeof n2 == "boolean" ? e2.append(t2, n2 ? "1" : "0") : typeof n2 == "string" ? e2.append(t2, n2) : typeof n2 == "number" ? e2.append(t2, "" + n2) : n2 == null ? e2.append(t2, "") : void c(n2, e2, t2);
    }
    function u(e2) {
      return new URL(e2.toString(), window.location.toString());
    }
    function h(e2, t2, r2, o2) {
      o2 === void 0 && (o2 = "brackets");
    ...
    var w = function() {
      ...
      return n2.init = function(e3) {
        ...
        typeof e3.target.hasAttribute == "function" && e3.target.hasAttribute("scroll-region") && this.saveScrollPositions();
        ...
        }), this.saveScrollPositions(), window.location.hash && ((e3 = document.getElementById(window.location.hash.slice(1))) == null || e3.scrollIntoView());
        ...
        window.sessionStorage.removeItem("inertiaLocationVisit"), e3.url += window.location.hash, e3.rememberedState = (t2 = (n3 = window.history.state) == null ? void 0 : n3.rememberedState) != null ? t2 : {}, e3.scrollRegions = (i2 = (r2 = window.history.state) == null ? void 0 : r2.scrollRegions) != null ? i2 : [], this.setPage(e3, { preserveScroll: s2.preserveScroll, preserveState: true }).then(function() {
          s2.preserveScroll && o2.restoreScrollPositions(), m(e3);
        });
      }, n2.isLocationVisitResponse = function(e3) {
        return e3 && e3.status === 409 && e3.headers["x-inertia-location"];
      }, n2.isInertiaResponse = function(e3) {
        return e3 == null ? void 0 : e3.headers["x-inertia"];
      }, n2.createVisitId = function() {
        return this.visitId = {}, this.visitId;
      }, n2.cancelVisit = function(e3, t2) {
        var n3 = t2.cancelled, i2 = n3 !== void 0 && n3, r2 = t2.interrupted, o2 = r2 !== void 0 && r2;
        ...
        return typeof e3 == "function" ? e3(t2) : e3 === "errors" ? Object.keys(t2.props.errors || {}).length > 0 : e3;
      }, n2.visit = function(e3, n3) {
        var i2 = this, o2 = n3 === void 0 ? {} : n3, a2 = o2.method, l2 = a2 === void 0 ? exports.Method.GET : a2, d2 = o2.data, v2 = d2 === void 0 ? {} : d2, m2 = o2.replace, g2 = m2 !== void 0 && m2, w2 = o2.preserveScroll, y2 = w2 !== void 0 && w2, S2 = o2.preserveState, b = S2 !== void 0 && S2, E = o2.only, P = E === void 0 ? [] : E, I = o2.headers, x = I === void 0 ? {} : I, V = o2.errorBag, T = V === void 0 ? "" : V, L = o2.forceFormData, O = L !== void 0 && L, k = o2.onCancelToken, C = k === void 0 ? function() {
        } : k, M = o2.onBefore, A = M === void 0 ? function() {
        } : M, F = o2.onStart, R = F === void 0 ? function() {
        } : F, j = o2.onProgress, D = j === void 0 ? function() {
        } : j, B = o2.onFinish, q = B === void 0 ? function() {
        } : B, N = o2.onCancel, H = N === void 0 ? function() {
        } : N, W = o2.onSuccess, G = W === void 0 ? function() {
        } : W, U = o2.onError, X = U === void 0 ? function() {
        } : U, J = o2.queryStringArrayFormat, K = J === void 0 ? "brackets" : J, _ = typeof e3 == "string" ? u(e3) : e3;
        if (!function e4(t2) {
          return t2 instanceof File || t2 instanceof Blob || t2 instanceof FileList && t2.length > 0 || t2 instanceof FormData && Array.from(t2.values()).some(function(t3) {
            return e4(t3);
          }) || typeof t2 == "object" && t2 !== null && Object.values(t2).some(function(t3) {
            return e4(t3);
          });
        ...
        if (A(Y) !== false && function(e4) {
          ...
          this.activeVisit = r({}, Y, { onCancelToken: C, onBefore: A, onStart: R, onProgress: D, onFinish: q, onCancel: H, onSuccess: G, onError: X, queryStringArrayFormat: K, cancelToken: t.CancelToken.source() }), C({ cancel: function() {
            ...
            var n4 = e4.data;
            P.length && n4.component === i2.page.component && (n4.props = r({}, i2.page.props, n4.props)), y2 = i2.resolvePreserveOption(y2, n4), (b = i2.resolvePreserveOption(b, n4)) && (t2 = window.history.state) != null && t2.rememberedState && n4.component === i2.page.component && (n4.rememberedState = window.history.state.rememberedState);
            ...
            if (i2.isLocationVisitResponse(e4.response)) {
              ...
              n4.hash && !t2.hash && p(n4).href === t2.href && (t2.hash = n4.hash), i2.locationVisit(t2, y2 === true);
            } else {
              if (!e4.response)
        ...
        var n3 = this, i2 = t2 === void 0 ? {} : t2, r2 = i2.visitId, o2 = r2 === void 0 ? this.createVisitId() : r2, s2 = i2.replace, a2 = s2 !== void 0 && s2, c2 = i2.preserveScroll, l2 = c2 !== void 0 && c2, d2 = i2.preserveState, h2 = d2 !== void 0 && d2;
        ...
        return t2 === void 0 && (t2 = {}), n3 === void 0 && (n3 = {}), this.visit(e3, r({}, n3, { method: exports.Method.GET, data: t2 }));
      }, n2.reload = function(e3) {
        return e3 === void 0 && (e3 = {}), this.visit(window.location.href, r({}, e3, { preserveScroll: true, preserveState: true }));
      }, n2.replace = function(e3, t2) {
        var n3;
        return t2 === void 0 && (t2 = {}), console.warn("Inertia.replace() has been deprecated and will be removed in a future release. Please use Inertia." + ((n3 = t2.method) != null ? n3 : "get") + "() instead."), this.visit(e3, r({ preserveState: true }, t2, { replace: true }));
      }, n2.post = function(e3, t2, n3) {
        return t2 === void 0 && (t2 = {}), n3 === void 0 && (n3 = {}), this.visit(e3, r({ preserveState: true }, n3, { method: exports.Method.POST, data: t2 }));
      }, n2.put = function(e3, t2, n3) {
        return t2 === void 0 && (t2 = {}), n3 === void 0 && (n3 = {}), this.visit(e3, r({ preserveState: true }, n3, { method: exports.Method.PUT, data: t2 }));
      }, n2.patch = function(e3, t2, n3) {
        return t2 === void 0 && (t2 = {}), n3 === void 0 && (n3 = {}), this.visit(e3, r({ preserveState: true }, n3, { method: exports.Method.PATCH, data: t2 }));
      }, n2.delete = function(e3, t2) {
        return t2 === void 0 && (t2 = {}), this.visit(e3, r({ preserveState: true }, t2, { method: exports.Method.DELETE }));
      }, n2.remember = function(e3, t2) {
        var n3, i2;
        t2 === void 0 && (t2 = "default"), g || this.replaceState(r({}, this.page, { rememberedState: r({}, (n3 = this.page) == null ? void 0 : n3.rememberedState, (i2 = {}, i2[t2] = e3, i2)) }));
      }, n2.restore = function(e3) {
        var t2, n3;
        if (e3 === void 0 && (e3 = "default"), !g)
          return (t2 = window.history.state) == null || (n3 = t2.rememberedState) == null ? void 0 : n3[e3];
      }, n2.on = function(e3, t2) {
        var n3 = function(e4) {
          var n4 = t2(e4);
          e4.cancelable && !e4.defaultPrevented && n4 === false && e4.preventDefault();
        };
    ...
    var y = { buildDOMElement: function(e2) {
      ...
      return n2 !== null ? t2.findIndex(function(e3) {
      ...
      Array.from(document.head.childNodes).filter(function(e3) {
        ...
        if (i2 !== -1) {
          ...
          o2 && !e3.isEqualNode(o2) && (e3 == null || (r2 = e3.parentNode) == null || r2.replaceChild(o2, e3));
        } else {
          var s2;
          e3 == null || (s2 = e3.parentNode) == null || s2.removeChild(e3);
        }
      ...
      return { createProvider: function() {
        ...
        return { update: function(t3) {
          return function(e4, t4) {
            t4 === void 0 && (t4 = []), e4 !== null && Object.keys(i2).indexOf(e4) > -1 && (i2[e4] = t4), s2();
          }(e3, t3);
        }, disconnect: function() {
          return function(e4) {
            e4 !== null && Object.keys(i2).indexOf(e4) !== -1 && (delete i2[e4], s2());
          }(e3);
        } };
      } };
    }, exports.hrefToUrl = u, exports.mergeDataIntoQueryString = h, exports.shouldIntercept = function(e2) {
      var t2 = e2.currentTarget.tagName.toLowerCase() === "a";
      return !(e2.target && e2 != null && e2.target.isContentEditable || e2.defaultPrevented || t2 && e2.which > 1 || t2 && e2.altKey || t2 && e2.ctrlKey || t2 && e2.metaKey || t2 && e2.shiftKey);
...
//# sourceMappingURL=chunk-PIBR4PNH.js.map
